...
namespace InvitationsService.Repository
{
    public class EmailsRepository : IEmailsRepository
    {
        ...
        public EmailsRepository(IBackgroundTaskQueue queue, ILogger<EmailsRepository> logger, IServiceScopeFactory serviceScopeFactory, IOptions<InvitationEmailSettings> invitationEmailSettings)
        {
            _logger = logger;
            Queue = queue;
